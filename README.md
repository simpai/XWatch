...
- 게시물 작성 중 한글 IME 입력 잘림을 줄이기 위한 입력 보정
- 예약하기 모달에서 빠른 시간 설정 버튼 제공
  - `5분뒤`, `10분뒤`, `30분뒤`, `1시간뒤`
  - `+1시간`, `-1시간`, `+1일`, `-1일`
- 한국어/영어 다국어 UI 지원
...
## 스토어 등록용 설명 문구
### 한국어 요약
X 프로필 메모와 예약 시간 단축 버튼을 제공하는 생산성 확장 프로그램
...
### English Summary
A productivity extension for X profile notes plus quick schedule-time shortcut buttons.
...
- Quick shortcuts in the schedule modal
